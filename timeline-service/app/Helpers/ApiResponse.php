...
class ApiResponse
{
     ...
     * @param  mixed|null  $data     Dữ liệu chi tiết lỗi kèm theo
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * @param  string      $message  Mô tả lỗi
     * @param  mixed|null  $errors   Danh sách lỗi
     * @return \Illuminate\Http\JsonResponse
     */
    ...
    /**
     * Trả về phản hồi lỗi máy chủ nội bộ (HTTP 500 Internal Server Error).
     *
